            ...
            <div className='w-full flex flex-col-reverse lg:flex-row justify-start items-center gap-4 lg:gap-10'>
                <div className='w-full space-y-5'>
                    ...
                    <h1 className='text-lg font-medium md:text-xl md:font-semibold'>
                        <span className='uppercase tracking-widest'>Abdikafi Isse Isak</span>
                        <span className='tracking-widest hidden md:inline'> - Miirshe</span>
                    </h1>
                    <h5 className='text-base font-extralight italic'>I'm MERN stack developer</h5>
                    <p className='text-base font-normal tracking-widest leading-10'>I'm a MERN stack developer. Proficient in both front-end and back-end development</p>
