...
const TechPreferences = () => {
    return (
        <div className='w-full mt-16'>
            <h1 className='text-lg md:text-xl font-bold lg:hidden capitalize'>Tech preferences</h1>
            <hr className='mt-5 w-full border-slate-50'/>
            <div className="w-full flex flex-col">
                <div className="-my-2 overflow-x-auto ">
                    <div className="w-full py-2 align-middle">
                        <div className="overflow-hidden shadow-md rounded-lg">
                            <table className="w-full">
                                <thead className="bg-[#F5F5F5] uppercase text-base leading-tight hidden lg:block">
                                    <tr>
                                        <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-lg font-medium text-gray-500 uppercase tracking-wider">
                                            Tech preferences
                                        </th>
                                    </tr>
                                </thead>
